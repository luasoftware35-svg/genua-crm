...
async function main() {
  ...
  const content = buildCompanyMailContent({
    companyName: "Afra Mensucat Sanayi ve Ticaret Ltd. Şti.",
    website: "https://aframensucat.com",
    source: "UOSB",
    auditPdfName: "61_Afra_Mensucat.pdf",
  });

  const pdfPath = getOutreachPdfPath("61_Afra_Mensucat.pdf");
